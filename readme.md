	...
	<section id="resume" class="grey-section">
		...
		<div class="row section-intro">
   		<div class="col-twelve">
   			...
   			<p class="lead">As crutial as tangible skills, successful projects and activations require strong leadership and communication skills. My years of experience in both the professional workforce and continuing education have shaped me to who I am today. Below is a small snippet of that experience.</p>
   				...
   				<div class="timeline-block">
	   				...
	   				<div class="timeline-content">
	   					...
	   					<ul>
	   						...
	   						<li>Created PRDs and worked with product management teams to define and deliver product enhancements</li>
   		...
   		<div class="col-twelve">
   			...
   			<div class="timeline-wrap">
   				...
   				<div class="timeline-block">
	   				...
	   				<div class="timeline-content">
	   					<h4>University of Western Ontario</h4>
	   					<p>Receieved a honors Bachelor of Science degree with a concentration in media, information and technology marketing and communications.</p>
	   				</div>
	...
	<section id="portfolio">
		...
		<div class="row section-intro">
   		<div class="col-twelve">
   			...
   			<p class="lead">Leading various Radeon Software launches, I have developed the strategy, as well as the creation of videos, infographics, presentations, social communication, and press engagment. Below are some examples of my work.</p>
	...
	<section id="contact">
   	...
   	<div class="row contact-form">
   		...
   		<div class="col-twelve">
            ...
            <!-- form -->
            <form name="contactForm" id="contactForm" form action="mailto:gsing994@gmail.com.com" method="post">
      			<fieldset>
